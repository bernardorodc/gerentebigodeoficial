  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className={`grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 transition-all duration-700 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div>
            <img 
              src="/logo com texto.png" 
              alt="Gerente Bigode" 
              className="h-10 mb-4 brightness-150 contrast-125"
            />
            <p className="text-gray-400 mb-4">
              Controle financeiro inteligente para empreendedores e profissionais autônomos.
            </p>
        ...
        <div className={`pt-8 mt-8 border-t border-gray-800 text-center text-gray-400 text-sm transition-all duration-700 delay-300 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <p>© {currentYear} Gerente Bigode. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
